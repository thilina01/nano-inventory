...
import { ReceiveComponent } from 'app/entities/receive/receive.component';
import { ReceiveService } from 'app/entities/receive/receive.service';
import { Receive } from 'app/shared/model/receive.model';

describe('Component Tests', () => {
    describe('Receive Management Component', () => {
        let comp: ReceiveComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ReceiveComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.receives[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
